        ...
        >
          ...
          <div className="xl:mt-6 flex flex-col justify-start items-start  px-4 w-full space-y-3 pb-5 ">
            ...
            <Link href="/">
              <button
                className={`${
                  router.pathname == "/" && "bg-indigo-700 text-white"
                } focus:outline-none flex jusitfy-start hover:text-white focus:bg-indigo-700 focus:text-white hover:bg-indigo-700 text-gray-600 rounded py-3 pl-4 items-center space-x-6 w-full`}
              >
                <svg
            ...
            <button
              className={`${
                ...
                router.pathname == "/categories/add"
                  ? "bg-indigo-700 text-white"
                  : ""
              } focus:outline-none flex jusitfy-start hover:text-white focus:bg-indigo-700 focus:text-white hover:bg-indigo-700 text-gray-600 rounded py-3 pl-4 items-center space-x-6 w-full`}
            >
            ...
            <Link href="/users">
              <button
                className={`${
                  router.pathname == "/users" || router.pathname == "/users/add"
                    ? "bg-indigo-700 text-white"
                    : ""
                } focus:outline-none flex jusitfy-start hover:text-white focus:bg-indigo-700 focus:text-white hover:bg-indigo-700 text-gray-600 rounded py-3 pl-4 items-center space-x-6 w-full`}
              >
