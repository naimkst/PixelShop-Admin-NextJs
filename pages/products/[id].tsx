                ...
                <div className="mt-10 px-7">
                  ...
                  <div className="grid w-full grid-cols-1 lg:grid-cols-2 md:grid-cols-1 gap-7 mt-7 ">
                    <div>
                      ...
                      <select className="
                              relative flex items-center justify-between w-full px-5 py-4 dropbtn-one
                              border border-gray-300 rounded outline-none dropdown-one mt-2 text-sm font-medium text-gray-600
